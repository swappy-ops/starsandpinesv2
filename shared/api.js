...
const API = {
  ...
  // ─── Places Guide ───
  getPlaces() { return this.get("/api/places"); },

  // ─── Perool Store ───
  getPeroolCategories() { return this.get("/api/perool/categories"); },
  getPeroolProducts(categoryId) { return this.get(`/api/perool/products?category_id=${encodeURIComponent(categoryId || '')}`); },

  // ─── Staff Contacts ───
  getStaffContacts() { return this.get("/api/staff/contacts"); },
};
